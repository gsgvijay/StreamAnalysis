...
public class CountMinSketchState implements State {
    ...
    double eps;
    double confidence;
	//Reference to the object that holds the priority queue for the top k elements.
	//The reference is used to increment the appropriate word every time it is added.
	TopList toplist;
    ...
    public void add(String item, long count) {
		...
		// The following add method call increments the value of the item in the priority queue
		//  that holds the top k words
		toplist.add(item);
